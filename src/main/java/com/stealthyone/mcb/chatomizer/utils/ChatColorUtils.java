...
public class ChatColorUtils {
    ...
    public static List<String> translateAlternateColorCodesList(List<String> list) {
        return translateAlternateColorCodesList('&', list);
    }

    public static List<String> translateAlternateColorCodesList(char code, List<String> list) {
        List<String> newList = new ArrayList<>();
        for (String string : list) {
            newList.add(ChatColor.translateAlternateColorCodes(code, string));
        }
        return newList;
    }
